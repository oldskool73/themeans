        ...
        $scope.switchFormOnClick = function (val) {
          ...
          if ($scope.createCustomDialog && val === 'create') {
            $mdDialog.show({
              ...
              locals: { parentDirectiveScope: $scope }
            });
            return;
          }
          $scope.formType = val;
