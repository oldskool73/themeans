...
angular.module('tm.global-ng-progress',['ngProgress'])
  ...
  .factory('globalNgProgress', function ($log, $q, $injector, $timeout) {
    ...
    return {
      // Before request (this intercepts the request setup, if nothing is returned then
      // it wont make a request)
