 ...
 */
angular
.module('tm.ionic-ng-camera', ['ionic'])
.service('tmCamera', function ($q, $ionicPlatform, $log, $window) {
  ...
  this.takePicture = function(cameraOptions) {
    ...
    if (!navigator || !navigator.camera) {
      ...
      return deferred.reject({
        message: 'Unable to use camera, please try again or contact support.'
      });
    }
    ...
    navigator
    .camera
    .getPicture(onSuccess, onFail, defaults);
